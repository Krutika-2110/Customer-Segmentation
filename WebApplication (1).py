...
def interpret_cluster(cluster):
    if cluster == 0:
        return "0 (where Customer is having low income and high Expenditure.)"
    elif cluster == 1:
        return "1 (where Customer is having lowest income and low Expenditure.)"
    elif cluster == 2:
        return "2 (where Customer is having highest income and high Expenditure.)"
    elif cluster == 3:
        return "3 (where Customer is having high income and highest Expenditure.)"
    elif cluster == 4:
        return "4 (where Customer is having high income and low Expenditure.)"
    else:
